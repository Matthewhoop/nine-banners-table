...
- **Decisions** — D&D-style input under the caption. Choice buttons and/or a “What do you do?” box. **One blade** (solo): one player claims the act; others can react; the caption advances after the actor Sends. **The table** (group): everyone picks and/or types; the card shows a tally. One vote is enough to Continue. After a vote the next caption shows at once so the story moves; tap the caption or the visible **Continue** if you already sent. The story auto-advances after that vote if only one blade is live at the table (one phone, one name); leftover names from an older session do not block a lone player. If several blades have joined recently, it waits until they have all voted, or someone who already voted (or the DM) hits **Continue**. **Call a decision** lets the DM spin a solo or group prompt mid-session without hardcoding the beat. A lone player can play Day 1 without a DM: inn → quay → hall → bridge → banquet. After each scene’s after-line the next room starts. Sample beats (player-safe, after the last caption line): Low Quay group — sit at the bar / back table / stay on your feet, then dawn quay; Pellane Quay solo — overhear a barge argument (listen / walk past / type it; others react), then the hall; Granary-Hall group — which banner to stand near, then the side-deal bridge; bridge group — walk with Ise / hear Aldren’s stair / decline, then the banquet; banquet group — whose toast you watch, then “The hymn is still coming. Night 1 holds.”
- **Talk** — tap Mara, Aldren, Lir, or any present portrait. They speak from their existing lines (plus a few generic inn/quay/hall replies — no spoilers). Whoever tapped stays the solo speaker: quick lines, a “What do you say?” box, and wrap-up choices (That’s enough / I’ll look around / I’ll leave it). After each Send the NPC answers and the Speak card stays up for another turn. It runs for about 3–5 exchanges, or until you wrap it up; they close with a line like “Stew’s up.” or “Don’t let me keep you.” and the card dismisses back to the scene. Empty Send does not end it. No D-pad.
